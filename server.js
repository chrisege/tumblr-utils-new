...
var tumblrConfig = require('./server/config.js');
...
app.use(cookieSession({  
    secret: tumblrConfig.EXPRESS_SESSION_SECRET, 
...
// some routes?
require('./server/routes/tumblr')(app);
...
new Moonboots({
    moonboots: {
        jsFileName: 'tumblr-utils',
        cssFileName: 'tumblr-utils',
...
console.log('Tumblr Utils is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
